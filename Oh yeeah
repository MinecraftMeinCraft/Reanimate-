...
tool7.Equipped:Connect(function()
    local character = player.Character
    if character then
        Anim7 = Animator.new(character, 137456359844967)
        Anim7:Play()
        Anim7.Stopped:Connect(function() Anim7:Play() end)
        sound7 = Instance.new("Sound")
        sound7.SoundId = getcustomasset("Mannrobics.mp3")
        sound7.Volume = 2
        sound7.Looped = true
...
-- Rakuten Lemonade
local tool14 = Instance.new("Tool")
tool14.Name = "Rakuten Lemonade"
tool14.RequiresHandle = false
tool14.Parent = backpack
...
local Anim14, sound14
tool14.Equipped:Connect(function()
    local character = player.Character
    if character then
        Anim14 = Animator.new(character, 18985726113)
        Anim14:Play()
        Anim14.Stopped:Connect(function() Anim14:Play() end)
        sound14 = Instance.new("Sound")
        sound14.SoundId = getcustomasset("Rakuten Lemonade.mp3")
        sound14.Volume = 2
        sound14.Looped = true
        sound14.Parent = character:WaitForChild("HumanoidRootPart")
        sound14:Play()
    end
end)
tool14.Unequipped:Connect(function()
    if Anim14 then Anim14:Stop(); Anim14:Destroy(); Anim14 = nil end
    if sound14 then sound14:Stop(); sound14:Destroy(); sound14 = nil end
end)

-- Lonely Lonely (Hakari)
local tool15 = Instance.new("Tool")
tool15.Name = "Lonely Lonely (Hakari)"
tool15.RequiresHandle = false
tool15.Parent = backpack

writefile("Lonely Lonely.mp3", game:HttpGet("https://github.com/gObl00x/Epik-Musics/raw/refs/heads/main/Lonely%20Lonely.mp3"))

local Anim15, sound15
tool15.Equipped:Connect(function()
    local character = player.Character
    if character then
        Anim15 = Animator.new(character, 92699725136780)
        Anim15:Play()
        Anim15.Stopped:Connect(function() Anim15:Play() end)
        sound15 = Instance.new("Sound")
        sound15.SoundId = getcustomasset("Lonely Lonely.mp3")
        sound15.Volume = 2
        sound15.Looped = true
        sound15.Parent = character:WaitForChild("HumanoidRootPart")
        sound15:Play()
    end
end)
tool15.Unequipped:Connect(function()
    if Anim15 then Anim15:Stop(); Anim15:Destroy(); Anim15 = nil end
    if sound15 then sound15:Stop(); sound15:Destroy(); sound15 = nil end
end)
